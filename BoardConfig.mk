...
TARGET_CPU_SMP := true
TARGET_BOOTLOADER_BOARD_NAME := n919
...
BOARD_EGL_CFG := device/zte/n919/configs/egl.cfg
...
# Hardware
BOARD_HARDWARE_CLASS := device/zte/n919/cmhw

# Kernel
BOARD_KERNEL_BASE := 0x00200000
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom androidboot.selinux=enforcing
BOARD_PAGE_SIZE := 2048
TARGET_KERNEL_SOURCE := kernel/zte/n919
TARGET_KERNEL_CONFIG := n919_defconfig
...
# SELinux
BOARD_SEPOLICY_DIRS += device/zte/n919/sepolicy
...
TARGET_CUSTOM_WIFI := ../../device/zte/n919/libhardware_legacy/wifi/wifi.c
